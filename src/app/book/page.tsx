          ...
          <div className="mb-8 relative z-10">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-2">
                <button
                  onClick={prevMonth}
                  className="w-10 h-10 rounded-full bg-[#1e1f23] flex items-center justify-center text-white hover:text-primary hover:bg-white/5 transition-colors border border-white/10"
                >
            ...
            <div className="grid grid-cols-7 gap-2">
              ...
              {Array.from({ length: daysInMonth }, (_, i) => i + 1).map((day) => {
                ...
                if (isPast) {
                  style = "text-white/20 cursor-not-allowed";
                } else if (isSelected) {
                  style =
                    "bg-primary text-[#0a0a0a] font-bold shadow-[0_0_15px_rgba(212,175,55,0.4)] cursor-pointer";
                } else if (isToday) {
                  style =
                    "text-primary border border-primary relative cursor-pointer";
                }
